...
public class HelloController implements Initializable {
    ...
    protected void onSaveClick() {
        ...
        AttackModule AtkMod =AttackModuleBuilder.buildAttackModule(cbAttackMod.getSelectionModel().getSelectedIndex());
    ...
    public void RepopulateTable(){
        ...
        gpAttackCont.getChildren().clear();
        DBHelpers dbh = new DBHelpers(DBHelpers.getGlobalConnection());
        ...
        for(Attack atk: allattacks.values()){
            ...
            try {
                ...
                gpAttackCont.add(sc,num_atk%contcol,num_atk/contcol);
            } catch (IOException e) {
